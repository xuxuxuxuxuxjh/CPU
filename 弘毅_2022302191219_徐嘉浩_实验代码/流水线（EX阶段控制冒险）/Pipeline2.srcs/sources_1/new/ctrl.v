...
// i format
 ...
 // j format
   ...
   // u format
   wire utype = ~Op[6] & Op[4] & ~Op[3] & Op[2] & Op[1] & Op[0]; // u 0*10111
  ...
  // NPC_JUMP    3'b010
  // NPC_JALR	3'b100
  assign NPCOp[0] = sbtype;//完整的应该是sbtype&Zero；Zero将在EX阶段补充
  assign NPCOp[1] = i_jal;
  assign NPCOp[2]= i_jalr;
    
    
    
    assign ALUOp[0] = itype_l|stype|i_addi|i_ori|i_add|i_or|i_lui|i_jalr|i_slli|i_sll|i_sra|i_sltu|i_sltiu|i_srai|i_bne|i_bge|i_bgeu;
    assign ALUOp[1] = i_andi|i_jalr|itype_l|stype|i_addi|i_add|i_and|i_auipc|i_slli|i_sll|i_slt|i_sltu|i_slti|i_sltiu|i_blt|i_bge;
    assign ALUOp[2] = i_andi|i_and|i_ori|i_or|i_bge|i_blt|i_bne|i_sub|i_xori|i_slli|i_xor|i_sll|i_beq;
