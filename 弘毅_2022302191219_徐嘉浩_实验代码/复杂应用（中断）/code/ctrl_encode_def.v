...
`define WDSel_FromPC 3'b001
`define WDSel_FromMEM_lw 3'b010
`define WDSel_FromMEM_lh 3'b011
`define WDSel_FromMEM_lb 3'b100
`define WDSel_FromMEM_lhu 3'b101
`define WDSel_FromMEM_lbu 3'b110
*/
`define WDSel_FromALU 3'b000
